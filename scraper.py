...
# Simple standalone scraper for testing
async def scrape_naukri_simple(role: str, location: str, pages: int = 3):
    """
    Simple standalone scraper for Naukri.
...
if __name__ == "__main__":
    jobs = asyncio.run(scrape_naukri_simple("Software Engineer", "Bangalore", pages=1))
